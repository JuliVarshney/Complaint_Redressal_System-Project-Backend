...
public class UserController {
	...
	public void createAdmin() {
		...
		admin.setPassword("admin123@crs");
		admin.setFirstName("Juli");
		admin.setLastName("Varshney");
		admin.setEmail("julievarshney1999@gmail.com");
		admin.setPinCode(120003);
		admin.setPhone("+917687982345");
